...
function TreasurerTenants() {
  ...
  const fetchTenants = async () => {
    ...
    try {
      ...
      // Fallback for demo
      setTenants([
        { id: 1, name: "Karthik", email: "karthik@gmail.com", phone: "077 123 4567", houseCode: "H001" },
        { id: 2, name: "Jack Brown", email: "jack123@gmail.com", phone: "077 548 5503", houseCode: "H002" },
        { id: 3, name: "Patrick Tompson", email: "pato@gmail.com", phone: "075 472 3652", houseCode: "H004" },
      ]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    ...
    >
      <Card title="Resident Management" subtitle="Manage and view contact information for all registered tenants.">
        {loading ? (
