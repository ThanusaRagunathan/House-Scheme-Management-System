...
function OwnerAddNotification() {
  ...
  return (
    <DashboardLayout role="owner" title="Broadcast Notification">
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <Card 
          ...
          subtitle="Send a notification or alert to all residents and the treasurer."
        >
          <form onSubmit={handleSubmit}>
            ...
            <TextArea
              ...
              rows={6}
              placeholder="Provide a clear and detailed announcement for the system..."
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px", marginTop: "30px", paddingTop: "20px", borderTop: "1px solid #eee" }}>
              <Button variant="secondary" onClick={() => navigate("/owner/notification")} disabled={loading}>
                Cancel
              </Button>
...
export default OwnerAddNotification;
